! function(t) {
    ...
    119: function(t, e, i) {
        ...
        s.on("show_variation", function(t, e) {
            e.hasOwnProperty("image") && e.image.thumb_src ? (jQuery(".product-gallery-slider-old .slide.first img, .product-thumbnails .first img, .product-gallery-slider .slide.first .zoomImg").attr("src", e.image.thumb_src).attr("srcset", ""), c.selectSliderFirstImage(), c.setImageZoomSrc()) : jQuery(".product-thumbnails .first img").attr("src", a)
        }), s.on("click", ".reset_variations", function() {
            jQuery(".product-thumbnails .first img").attr("src", a), c.selectSliderFirstImage(), c.setImageZoomSrc()
                    ...
                    jQuery(e).hasClass("quick-view-added") || (jQuery(e).click(function(t) {
                        if ("" != jQuery(this).attr("data-prod")) {
                            ...
                            jQuery.post(flatsomeVars.ajaxurl, i, function(t) {
                                ...
                                var e = jQuery(".product-lightbox form.variations_form");
                                jQuery(".product-lightbox form").hasClass("variations_form") && e.wc_variation_form();
                                var i = jQuery(".product-lightbox .product-gallery-slider"),
                                    o = jQuery(".product-lightbox .product-gallery-slider .slide.first img"),
                                    r = jQuery(".product-lightbox .product-gallery-slider .slide.first a"),
                                    a = o.attr("data-src") ? o.attr("data-src") : o.attr("src");
                                e.on("show_variation", function(t, e) {
                                    e.image.src ? (o.attr("src", e.image.src).attr("srcset", ""), r.attr("href", e.image_link), i.flickity("select", 0)) : e.image_src && (o.attr("src", e.image_src).attr("srcset", ""), r.attr("href", e.image_link), i.flickity("select", 0))
                                }), e.on("click", ".reset_variations", function() {
                                    o.attr("src", a).attr("srcset", ""), i.flickity("select", 0)
